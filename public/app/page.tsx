...
export default function HomePage() {
  ...
  useEffect(() => {
    // Read-only on mount: load products. The Pi SDK is never touched here, so a
    // normal browser can never auto-enter a "Connecting…" state — that only
    // happens after the user taps Login with Pi (handled inside <PiLogin />).
